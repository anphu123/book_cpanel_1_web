...
public class CoinControllerApi {
    ...
    @PatchMapping("/{customerid}/subtract")
    public ResponseEntity<Integer> subtractPrice(@PathVariable int customerid, @RequestParam int amount) {
        try {
            int newPrice = coinService.subtractPrice(customerid, amount);
