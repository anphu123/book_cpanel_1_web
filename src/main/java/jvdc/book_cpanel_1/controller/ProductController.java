...
import jvdc.book_cpanel_1.services.FirebaseFileService;
...
public class ProductController {
    ...
    public ModelAndView home(){
        ModelAndView mv = new ModelAndView("manhinh12.1_Product_Dashboard");
    ...
    public String addImage(Model model){
        ...
        return "manhinh12.2_Product_ThemMoi";
    }
